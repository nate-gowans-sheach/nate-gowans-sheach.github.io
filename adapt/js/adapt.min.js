...
define('theme/5e3afd944fc6810a5ad8d991/js/vanilla',['require','coreJS/adapt','backbone'],function(require) {
...
;
define("plugins", ["components/adapt-contrib-graphic/js/adapt-contrib-graphic","components/adapt-contrib-hotgraphic/js/adapt-contrib-hotgraphic","components/adapt-contrib-narrative/js/adapt-contrib-narrative","components/adapt-contrib-text/js/adapt-contrib-text","components/adapt-hotgrid/js/adapt-hotgrid","components/adapt-imageJuxtapose/js/adapt-imageJuxtapose","extensions/adapt-block-background/js/adapt-block-background","extensions/adapt-close/js/adapt-close","extensions/adapt-contrib-assessment/js/adapt-assessmentArticleExtension","extensions/adapt-contrib-bookmarking/js/adapt-contrib-bookmarking","extensions/adapt-contrib-drawerPageNavigation/js/adapt-contrib-drawerPageNavigation","extensions/adapt-contrib-languagePicker/js/adapt-languagePicker","extensions/adapt-contrib-pageLevelProgress/js/adapt-contrib-pageLevelProgress","extensions/adapt-contrib-resources/js/adapt-contrib-resources","extensions/adapt-contrib-spoor/js/adapt-contrib-spoor","extensions/adapt-contrib-trickle/js/adapt-contrib-trickle","extensions/adapt-contrib-tutor/js/adapt-contrib-tutor","extensions/adapt-minimap/js/adapt-minimap","extensions/adapt-quicknav/js/adapt-quicknav","extensions/adapt-splitscreen/js/adapt-splitscreen","menu/adapt-contrib-boxMenu/js/adapt-contrib-boxmenu","theme/5e3afd944fc6810a5ad8d991/js/vanilla"], function(){});
